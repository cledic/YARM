...
uint32_t APDS_9660_EnableLightSensor( uint8_t interrupts);          // def false
uint32_t APDS_9660_DisableLightSensor( void);
uint32_t APDS_9660_EnableProximitySensor( uint8_t interrupts);      // def false
uint32_t APDS_9660_DisableProximitySensor( void);
uint32_t APDS_9660_EnableGestureSensor( uint8_t interrupts);     // def true
...
uint32_t APDS_9660_SetAmbientLightGain(uint8_t gain);
uint8_t APDS_9660_GetProximityGain(uint8_t*gain);
uint32_t APDS_9660_SetProximityGain(uint8_t gain);
